...
public class MovieApp extends Application {
    ...
    private static void setSmallView(String fxmlFile) {
        try {
            FXMLLoader loader = new FXMLLoader(MovieApp.class.getClass().getResource(fxmlFile));
    ...
    public static void setPersonView(String login) {
        ...
        switch (type) {
            case "KinoKompany":
                fxml = "/View/KinoKompanyFXML.fxml";
                break;
            case "Cashier":
    ...
    public static void FilmView(String login, String stat1, String stat2) {
        String fxml = "/View/FilmFXML.fxml";
