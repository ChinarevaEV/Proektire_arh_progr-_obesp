...
import static Controller.KinoKompanyFXMLController.login;
...
static String login;
    ...
    private void initTableView(LocalDate dt) {
        ...
        TableColumn<Seans, String> name = new TableColumn<>("Film Name");
        name.setMaxWidth(300);
        name.setCellValueFactory(cell -> 
                new SimpleStringProperty(cell.getValue().getSeansfilm().getName()));
            ...
            row.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent event) {
                    if (event.getClickCount() == 2 && (!row.isEmpty())) {
                        ...
                        MovieApp.BronView(login,"",Integer.toString(rowData.getId()));
            ...
            row.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent event) {
                    if (event.getClickCount() == 2 && (!row.isEmpty())) {
                        ...
                        MovieApp.BiletView(login,"",Integer.toString(rowData.getId()));
